...
public class CpbOrgDev20150625 {
	...
	private Date dctmGroupRebuildDatetime;

	@JsonIgnore

	public CpbOrgDev20150625() {
		super();
	}

	public CpbOrgDev20150625(Long orgId, String orgCode, String orgName, String orgSname, Long orgIdRef, Integer orgType, Integer status, String updateUser, Date updateDatetime, Integer dctmGroupRebuildStatus, Date dctmGroupRebuildDatetime) {
		super();
		this.orgId = orgId;
	...
	public String toString() {
		return "CpbOrgDev20150625 [orgId = " + orgId + ", orgCode = " + orgCode + ", orgName = " + orgName + ", orgSname = " + orgSname + ", orgIdRef = " + orgIdRef + ", orgType = " + orgType + ", status = " + status + ", updateUser = " + updateUser + ", updateDatetime = " + updateDatetime + ", dctmGroupRebuildStatus = " + dctmGroupRebuildStatus + ", dctmGroupRebuildDatetime = " + dctmGroupRebuildDatetime + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CpbOrgDev20150625 other = (CpbOrgDev20150625) obj;
