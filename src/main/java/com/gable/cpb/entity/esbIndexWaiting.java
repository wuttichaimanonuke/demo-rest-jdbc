...
public class esbIndexWaiting {
	...
	public esbIndexWaiting() {
		super();
	}

	public esbIndexWaiting(String indWaitingId, Date indTimestamp) {
		super();
	...
	public String toString() {
		return "esbIndexWaiting [indWaitingId = " + indWaitingId + ", indTimestamp = " + indTimestamp + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		esbIndexWaiting other = (esbIndexWaiting) obj;
