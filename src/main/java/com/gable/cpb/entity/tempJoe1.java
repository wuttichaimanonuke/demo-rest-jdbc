...
public class tempJoe1 {
	...
	public tempJoe1(String wdReqNo, String wdDocId, Integer wdDocType, Integer wdStatus, Date createDatetime, String createUser, Date updateDatetime, String updateUser) {
		super();
	...
	public String toString() {
		return "tempJoe1 [wdReqNo = " + wdReqNo + ", wdDocId = " + wdDocId + ", wdDocType = " + wdDocType + ", wdStatus = " + wdStatus + ", createDatetime = " + createDatetime + ", createUser = " + createUser + ", updateDatetime = " + updateDatetime + ", updateUser = " + updateUser + "]";
	}
