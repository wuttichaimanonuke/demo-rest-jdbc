...
public class esbFlStepLek {
	...
	public esbFlStepLek(Long stepId, Long flowId, String stepDesc, Long orgId, Long roleId, Long userId, Integer status, String updateUser, Date updateDatetime, Long stepOrder) {
		super();
		this.stepId = stepId;
		this.flowId = flowId;
	...
	public String toString() {
		return "esbFlStepLek [stepId = " + stepId + ", flowId = " + flowId + ", stepDesc = " + stepDesc + ", orgId = " + orgId + ", roleId = " + roleId + ", userId = " + userId + ", status = " + status + ", updateUser = " + updateUser + ", updateDatetime = " + updateDatetime + ", stepOrder = " + stepOrder + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		esbFlStepLek other = (esbFlStepLek) obj;
		if (flowId == null) {
