...
public class EdReqBorrowRowMapper implements RowMapper<EdReqBorrow> {

	@Override
	public EdReqBorrow mapRow(ResultSet row, int rowNum) throws SQLException {
		EdReqBorrow entity = new EdReqBorrow();
