...
public class CpbOrgPrdTemp {
	...
	public CpbOrgPrdTemp() {
		super();
	}

	public CpbOrgPrdTemp(Long orgId, String orgCode, String orgName, String orgSname, Long orgIdRef, Integer orgType, Integer status, String updateUser, Date updateDatetime) {
		super();
		this.orgId = orgId;
	...
	public String toString() {
		return "CpbOrgPrdTemp [orgId = " + orgId + ", orgCode = " + orgCode + ", orgName = " + orgName + ", orgSname = " + orgSname + ", orgIdRef = " + orgIdRef + ", orgType = " + orgType + ", status = " + status + ", updateUser = " + updateUser + ", updateDatetime = " + updateDatetime + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CpbOrgPrdTemp other = (CpbOrgPrdTemp) obj;
		if (orgCode == null) {
