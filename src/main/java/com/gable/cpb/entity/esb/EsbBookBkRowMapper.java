...
public class EsbBookBkRowMapper implements RowMapper<EsbBookBk> {

	@Override
	public EsbBookBk mapRow(ResultSet row, int rowNum) throws SQLException {
		EsbBookBk entity = new EsbBookBk();
